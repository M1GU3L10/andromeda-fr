...
const Products = () => {
    ...
    const fetchCategoryData = async () => {
        try {
            const response = await axios.get('http://localhost:1056/api/categories'); // Assuming you have an endpoint for categories
        ...
        <>
                                        ...
                                        {productData.map((item) => (
                                            <tr key={item.Id_Producto}>
                                                ...
                                                <td>
                                                    ...
                                                    <Button color="secondary" className='secondary' onClick={() => handleEditOpen(item)}><FaPencilAlt /></Button>
                                                    <Button color='error' className='delete' onClick={() => handleDelete(item.Id_Producto)}><IoTrashSharp /></Button>
                                                </td>
                                            </tr>
                                        ))}
                                    </tbody>
            ...
            <Modal open={open} onClose={handleClose}>
                <Box sx={style}>
                    ...
                    <FormControl fullWidth margin="normal" variant="outlined">
                        ...
                        {formErrors.Category_Id && <Typography color="error" variant="caption">{formErrors.Category_Id}</Typography>}
                    </FormControl>
                    <TextField
                        label="Image URL"
                        name="Image_URL"
            ...
            <Modal open={openEdit} onClose={handleEditClose}>
                <Box sx={style}>
                    ...
                    />
                    <FormControl fullWidth margin="normal" variant="outlined">
                        <InputLabel id="category-edit-select-label">Category</InputLabel>
                        <Select
